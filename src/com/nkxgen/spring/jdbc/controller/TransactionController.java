...
public class TransactionController {
	...
	/*
	 * @RequestMapping(value = "/loanrepaymenturl") public String loanrepaymenturl(@RequestParam("AccountNumber") long
	 * loan_id, Model model) { long loan_Id = loan_id; ti.loanRepayment(loan_Id); return "Loan_Repayment"; }
	 */
